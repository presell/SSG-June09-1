...
import TextInput from "../../TextInput"; // plasmic-import: IPdAtRJrtj45/component
...
import sty from "./PlasmicEditable.module.css"; // plasmic-import: _4GX0kVcpccZ/css
    ...
    >
      <div
        className={classNames(
          ...
          "editableText",
          {
            [sty.freeBoxeditEnabled___8Z6Rw58Nap]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      <div
        className={classNames(
          ...
          "textEditor",
          {
            [sty.freeBoxeditEnabled__ml7L758Nap]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      >
        {(hasVariant($state, "editEnabled", "editEnabled") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <TextInput
                  className={classNames("__wab_instance", sty.textInput__fd4CD)}
                  endIcon={null}
                  startIcon={null}
                />
              ),
