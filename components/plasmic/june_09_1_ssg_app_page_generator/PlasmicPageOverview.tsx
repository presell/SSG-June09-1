...
import SqueezeVariant2 from "../../SqueezeVariant2"; // plasmic-import: Vvm5J3NXNMdl/component
...
import sty from "./PlasmicPageOverview.module.css"; // plasmic-import: WdpAgxx1IaPW/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    cms: usePlasmicDataOp(() => {
      return {
        ...
        opId: "605720b2-748a-4104-8bd4-3a9646716aac",
        userArgs: {
          filters: [$ctx.params.slug]
        },
        cacheKey: `plasmic.$.605720b2-748a-4104-8bd4-3a9646716aac.$.`,
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          {(() => {
            try {
              return $queries.cms.isLoading == false;
            } catch (e) {
              if (
                e instanceof TypeError ||
                e?.plasmicType === "PlasmicUndefinedDataError"
