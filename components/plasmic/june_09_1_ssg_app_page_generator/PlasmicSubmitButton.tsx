...
import sty from "./PlasmicSubmitButton.module.css"; // plasmic-import: YJSBDyeq7vbt/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: T1st8VkYys0t/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: wQrP42HTYpQo/icon
...
export interface DefaultSubmitButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xqrF)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__mSl6)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicSubmitButton>(
    PlasmicSubmitButton,
    props,
    {
